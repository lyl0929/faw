...
import com.nua.faw.base.Constant;
import com.nua.faw.utils.NetworkUtils;
...
public class RetrofitManager {
    ...
    private static final Interceptor mRewriteCacheControlInterceptor = new Interceptor() {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (NetworkUtils.isConnected()) {
                //有网的时候读接口上的@Headers里的配置，可以在这里进行统一的设置//request.cacheControl().toString();
                String cacheControl = "application/json;charset=UTF-8";
            ...
            synchronized (RetrofitManager.class) {
                ...
                if (mOkHttpClient == null) {
                    mOkHttpClient = new OkHttpClient.Builder().cache(cache)
                            ...
                            .addInterceptor(new LoggerInterceptor("faw", Constant.DEBUG_MODE))
...
//                            .sslSocketFactory(sslParams.sSLSocketFactory, sslParams.trustManager)
    ...
    public static <T> T create(Class<T> clazz) {
        Retrofit retrofit = new Retrofit.Builder().baseUrl(Constant.getBaseUrl())
...
//    public Subscription json(String url, String params, Subscriber<HttpResult> subscriber) {
//        RequestBody body = RequestBody.create(okhttp3.MediaType.parse("application/json; charset=utf-8"),
//                EncodeUtils.urlEncode((params)));
//        return apiService.json(url, body)
