        ...
        for (String key : keys) {
            ...
            try {
                if (value == null) {
                    ...
                    Logger.e(String.format("Con't support save this type:%s, value:%s, key:%s",
                            type, value, key));
                }
            } catch (IllegalArgumentException e) {
                Logger.e("Save error:" + e.getMessage());
            }
        }
    ...
    private static <T> void buildValuesToMap(Class<?> clx, T t, String preFix,
        ...
        for (Field field : fields) {
            ...
            try {
                ...
                Logger.e("buildValuesToMap error:" + e.getMessage());
                continue;
            }
        ...
        for (Field field : fields) {
            ...
            if (value != null) {
                try {
                    ...
                    e.printStackTrace();
                    Logger.e(String.format("Set field error, Key:%s, type:%s, value:%s",
                            key, fieldType, value));
                }
            } else {
                Logger.e(String.format("Get field value error, Key:%s, type:%s",
                        key, fieldType));
            }
        }
