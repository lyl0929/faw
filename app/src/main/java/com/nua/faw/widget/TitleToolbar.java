...
//                LayoutParams.MATCH_PARENT, SizeUtils.dp2px(context, 20), Gravity.BOTTOM));
        ...
        if (!isChild(mTitleLayout)) {
            ...
            layoutParams.leftMargin = mBackTextView.getWidth();
            layoutParams.rightMargin = SizeUtils.dp2px(getContext(), 16);
        ...
        if (!isChild(mCloseTextView)) {
            ...
            Drawable drawable = typedArray.getDrawable(R.styleable.TitleToolbar_closeIcon);
            if (drawable != null) {
                mCloseTextView.setCompoundDrawablesWithIntrinsicBounds(drawable, null, null, null);
            }
